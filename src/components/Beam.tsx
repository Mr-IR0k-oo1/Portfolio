...
const CanvasWrapper: FC<{ children: ReactNode }> = ({ children }) => (
  <Canvas dpr={[1, 2]} frameloop="always" className="beams-container" gl={{ alpha: true, antialias: true }}>
    {children}
  </Canvas>
);
...
const Beams: FC<BeamsProps> = ({
  ...
  vec3 getNormal(vec3 pos) {
    ...
    gl_FragColor.rgb -= randomNoise / 15. * uNoiseIntensity;`
        ...
        material: { fog: true },
        uniforms: {
          diffuse: new THREE.Color(...hexToNormalizedRGB('#220000')),
  ...
  return (
    <CanvasWrapper>
      ...
      <ambientLight intensity={0.5} color="#440000" />
